...
update msg model =
    case msg of
        ...
        Cancel ->
            ( { model | fileName = "", isLoading = False }, Cmd.none )
        ...
        [ div []
            ([ if model.isLoading then
                div
                    ...
                    [ div [ class "text-xl font-semibold" ] [ text "Uploading CSV..." ] ]
               else
                text ""
            ]
            ++
                    ...
                    [ section [ id "import-data", class "import-data-section text-center" ]
                        ...
                        , Html.form
                            ...
                            , div [ class "button-group flex justify-end space-x-4 mt-4" ]
                                [ button [ type_ "submit", disabled model.isLoading, class "btn btn-primary text-white px-4 py-2 rounded-md hover:bg-blue-600" ] [ text "Upload CSV" ]
                                , button [ class "clear-btn bg-gray-300 text-gray-800 px-4 py-2 rounded-md hover:bg-gray-400", onClick Cancel, disabled model.isLoading ] [ text "Cancel" ]
                                ]
                            ]
                        ]
                    ]
